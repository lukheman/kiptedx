<div>
    ...
    <x-page-header title="Profil Mahasiswa" subtitle="Kelola foto profil dan password Anda" />
        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="modern-card h-100">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $mahasiswa->nim }}" readonly disabled style="cursor: not-allowed;">
                </div>

                <div class="mb-3">
                    <label class="form-label text-muted">Nama Lengkap</label>
                    <input type="text" class="form-control" value="{{ $mahasiswa->nama }}" readonly disabled style="cursor: not-allowed;">
                </div>
            ...
            <div class="modern-card h-100">
                ...
                <div class="text-center mb-4">
                    @if ($mahasiswa->foto_profil)
                        <img src="{{ Storage::url($mahasiswa->foto_profil) }}" class="rounded-circle border" style="width: 120px; height: 120px; object-fit: cover;">
                    @else
